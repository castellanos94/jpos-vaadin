package com.castellanos94.web.pos.views.reporte;

import com.castellanos94.web.pos.data.entity.SampleAddress;
import com.castellanos94.web.pos.data.service.SampleAddressService;
...
@RolesAllowed("ADMIN")
public class ReporteView extends Div {
    ...
    public ReporteView(SampleAddressService addressService) {
